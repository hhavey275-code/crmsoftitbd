            ...
            <CardContent>
              ...
              {insights?.daily_spend_limit > 0 && (
                <div className="flex justify-between text-sm mt-4 p-3 rounded-lg bg-muted/50">
                  ...
                  <span className="font-semibold">${Number(insights.daily_spend_limit).toLocaleString(undefined, { minimumFractionDigits: 2, maximumFractionDigits: 2 })}</span>
                </div>
              )}
              <div className="mt-4">
