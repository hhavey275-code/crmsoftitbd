...
async function processAccount(
  ...
  try {
    ...
    // Daily spend limit and billing threshold removed from UI
    // as Meta API doesn't reliably provide these fields.
    const dailySpendLimit = 0;
    const billingThreshold = 0;
